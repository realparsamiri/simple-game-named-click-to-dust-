...
class p1(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Click to Dust 1-Level1")
    ...
    def initUI(self):
        ...
        self.mission_One = QLabel("Mission 1: 20 clicks to pass")
        ...
        self.mission_Two = QLabel("Mission 2: 50 clicks to pass")
        ...
        """)
        self.btn_next.clicked.connect(self.nextLevel)
        self.btn_next.hide()
    ...
    def nextLevel(self):
            self.level_unlocked = mainclass()
            self.start = p2()
            self.start.show()
            self.level_unlocked.btn_lvl2.setText("Level 2")
